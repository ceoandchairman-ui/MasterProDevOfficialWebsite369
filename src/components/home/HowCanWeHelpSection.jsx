...
export default function HowCanWeHelpSection() {
  ...
  const [recordedBlob, setRecordedBlob] = useState(null); // Fix: Initialize with useState(null)
        ...
        <div
          ...
          <div className="absolute -top-6 left-12">
            <div
              ...
              <h2 className="text-lg md:text-xl font-bold text-black">How Can We Help You?</h2>
            </div>
          </div>

          <section id="how-we-help" className="mt-12">
